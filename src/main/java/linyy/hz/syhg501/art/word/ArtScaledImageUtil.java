 ...
 * @created 2014-7-26
 */
public class ArtScaledImageUtil {

    public static int snapHeightMax = 196;

    public static int snapWidthMax = 200;

    public static void scaledImage(String originalImagePath, int scaled,
            String scaledImagePath) {
        try {
            ImageIcon icon = getImage(
                ImageIO.read(new File(originalImagePath)), 5);
            ...
            ImageIO.write(savedImage, getPostfix(originalImagePath), new File(
                scaledImagePath));
    ...
    public static String getPostfix(String inputFilePath) {
        return inputFilePath.substring(inputFilePath
            .lastIndexOf(ArtCommon.FULL_STOP) + 1);
    }
    ...
    public static Image getImages(Image img, int scaled) {
        ...
        double scaleds = getScaling(img.getWidth(null), img.getHeight(null),
            scaled);
    ...
    public static Image getScaledImage(Image srcImg, int width, int heigth) {
        ...
        Image image = srcImg.getScaledInstance(srcImg.getWidth(null),
            srcImg.getHeight(null), Image.SCALE_DEFAULT);
